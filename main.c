...
int main() 
{
    ...
    while(1)
    {
        ...
        float frameTime = (float)(timeAfter - timeBefore) / CLOCKS_PER_SEC;     // Подсчет времени кадра
        ...
        // Вывод данных о игроке и миникарты
        mvprintw(0,0,"x = %f, y = %f, direction = %f, fps = %f",playerX, playerY, playerDir, 1.0f / frameTime);
